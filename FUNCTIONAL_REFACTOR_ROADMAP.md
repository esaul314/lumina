...
- The next Step 5 seam is the remaining live-sync consumer audit; view-specific state effects stay outside the pure snapshot projection.
...
- Step 5 next seam: audit the remaining client snapshot normalization and live-sync projections after the shared response projection, preserving explicit transport effects and view-specific state application.
