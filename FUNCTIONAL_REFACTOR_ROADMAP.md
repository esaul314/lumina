...
- Step 5 next seam: audit snapshot normalization and live-sync projections after the request boundary, starting with `useLuminaActions` response application and app-level `state-sync` reconciliation.
