...
- Next: begin implementation companion Step 5, aligning the client control surface with the same functional command, snapshot, and transport boundaries.
- In parallel: continue the Phase 1 implementation companion track in [FUNCTIONAL_REFACTOR_ROADMAP.md](./FUNCTIONAL_REFACTOR_ROADMAP.md), where Steps 1 through 4 are complete and Step 5 is the active refactor checkpoint.
