...
- Next: continue Step 5 by auditing the remaining client read/request contracts and live-sync projections without moving view-specific presentation into the snapshot boundary.
...
- Next Step 5 target: audit the remaining client snapshot normalization and live-sync projections after the response-to-state boundary, keeping compatibility shaping pure and transport/view effects explicit.
