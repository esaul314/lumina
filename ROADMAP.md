...
- Latest Step 4 slice: effect interpretation now uses the same closed indexed interpreter as reducer families, so unknown and inherited effect keys remain silent no-ops without open object-property dispatch.
