...
- Next Step 5 target: audit the remaining client live-sync consumers after the response-to-state boundary, keeping compatibility shaping pure and transport/view effects explicit.
