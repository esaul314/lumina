...
- Next focus: migrate any remaining operator-triggered async work that fits the same REST command boundary, then keep shrinking socket-only compatibility shims.
